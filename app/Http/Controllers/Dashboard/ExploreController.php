...
class ExploreController extends Controller
{
    ...
    public function index()
    {
        ...
        if(auth()->user()->user_type == 2) {
            return view('pages.dashboard.explore.doctor', ['stories' => $stories]);
        }
        else {
            return view('pages.dashboard.explore.patient', ['stories' => $stories]);
        }
    }
    ...
    {
        $data = ['story' => $this->get_story_resource(Story::where('id', $story)->first())];
        return view('pages.blogs.explore', $data);
    }
}
